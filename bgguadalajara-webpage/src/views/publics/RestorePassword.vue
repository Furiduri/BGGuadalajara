                ...
                <div class="h-full w-full m-0 py-7 px-4"
                    ...
                    <div class="w-full md:w-10 mx-auto">
                        ...
                        <div class="formgroup-inline">
                            <label for="password2" class="block text-900 font-medium text-xl mb-2">Repite
                                Contraseña</label>
                            <password id="password2" v-model="password2" placeholder="Repite Contraseña"
...
export default defineComponent({
    setup() {
        ...
        return { password1, password2, isEqual }
    }
})
</script>
